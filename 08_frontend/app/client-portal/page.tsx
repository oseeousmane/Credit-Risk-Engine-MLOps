...
import {
  ...
  ArrowRight, Shield, Loader2, Plus, ChevronRight,
  Calendar, Sparkles, CircleDot, TrendingUp, FolderOpen
} from 'lucide-react'
...
const PIPELINE_STEPS = [
  ...
  { key: 'assessment',  label: 'Credit Assessment' },
...
export default function ClientPortalDashboard() {
  ...
  return (
    <div className="relative pb-10 overflow-x-hidden min-h-screen">
      ...
      <div className="absolute top-[-100px] left-[-150px] w-[500px] h-[500px] bg-[#3ECF8E]/[0.03] rounded-full blur-[120px] pointer-events-none" />
        ...
        <motion.div variants={itemVariants} className="flex items-start justify-between gap-4">
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-[11px] font-medium uppercase tracking-[0.18em] text-zinc-500">Client Workspace</span>
            </div>
            <h1 className="text-2xl font-medium text-white tracking-tight">
              Good {getGreeting()}, {firstName}
            </h1>
            <p className="text-zinc-500 text-[13px] mt-1">
              {companyName} · Institutional Credit Portal
            </p>
          </div>
          <Link
            href="/client-portal/applications/new"
            className="flex-shrink-0 flex items-center gap-2 px-4 py-2 bg-[#3ECF8E] hover:bg-[#3ECF8E]/90 text-[#0a0a0a] rounded-md text-[13px] font-semibold transition-all shadow-[0_0_24px_rgba(62,207,142,0.15)] hover:shadow-[0_0_36px_rgba(62,207,142,0.25)]"
          >
            ...
            <Link href="/client-portal/documents" className="block">
              <div className="flex items-center gap-4 px-5 py-4 bg-amber-500/10 border border-amber-500/20 rounded-2xl hover:border-amber-500/30 transition-all group overflow-hidden relative">
                ...
                <div className="flex-1 relative z-10">
                  <div className="text-[13px] font-medium tracking-tight text-amber-400">Action Required — Documents Pending</div>
                  <div className="text-[12px] text-amber-400/70 mt-0.5">
                    {actionRequired.length} application{actionRequired.length > 1 ? 's' : ''} require{actionRequired.length === 1 ? 's' : ''} additional documents to proceed.
                  </div>
                </div>
          ...
          {loading ? (
            ...
            [
              ...
              },
              {
                ...
                accent: 'amber',
                colorCode: '#f59e0b',
                hint: actionRequired.length > 0 ? 'Action required' : 'All uploaded',
              ...
              },
              {
                ...
                accent: 'indigo',
                colorCode: '#6366f1',
                hint: unread.length > 0 ? 'New updates' : 'All read',
                href: '/client-portal/notifications',
              },
            ].map((kpi, i) => {
              const Icon = kpi.icon
              const palette = {
                blue:   { card: 'border-white/[0.06] hover:border-[#3ECF8E]/30',   icon: 'bg-[#3ECF8E]/10 text-[#3ECF8E]',   val: 'text-white', hint: 'text-zinc-500' },
              ...
              // We alter the sparkline data slightly for each card to look dynamic
        ...
        <motion.div variants={itemVariants} className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-7 space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Link
                href="/client-portal/applications"
                className="text-[12px] text-[#3ECF8E] hover:text-[#3ECF8E]/80 font-medium flex items-center gap-1 transition-colors"
              >
            ...
            {loadingApps ? (
              ...
              <div className="bg-red-500/8 border border-red-500/20 rounded-2xl p-6 text-center">
                ...
                <p className="text-[13px] text-red-400 font-medium">Could not load applications</p>
              ...
              <div className="bg-[#0a0a0a] border border-dashed border-white/[0.07] rounded-2xl p-10 text-center">
                ...
                <p className="text-[13px] font-medium tracking-tight text-zinc-300 mb-1">No applications yet</p>
                <p className="text-[12px] text-zinc-500 mb-5">Start by submitting your first facility request.</p>
                <Link
                  href="/client-portal/applications/new"
                  className="inline-flex items-center gap-2 px-4 py-2 bg-[#3ECF8E]/10 border border-[#3ECF8E]/20 rounded-md text-[13px] font-medium text-[#3ECF8E] hover:bg-[#3ECF8E]/20 transition-all"
                >
              ...
              (applications as any[]).slice(0, 3).map((app: any) => {
                ...
                return (
                  <Link key={app.id} href={`/client-portal/applications/${app.id}`} className="block">
                    <div className="bg-[#0a0a0a] border border-white/[0.06] rounded-2xl p-5 hover:border-[#3ECF8E]/25 hover:bg-[#0c0c0c] transition-all group cursor-pointer">
                      <div className="flex items-start justify-between gap-4">
                        ...
                        <ArrowRight className="w-4 h-4 text-zinc-600 group-hover:text-[#3ECF8E] group-hover:translate-x-0.5 transition-all mt-1 flex-shrink-0" />
                      </div>
          ...
          <div className="col-span-5 space-y-5">
            ...
            <div className="bg-[#0a0a0a] border border-white/[0.06] rounded-2xl p-5">
              ...
              {!primaryApp ? (
                <div className="text-[12px] text-zinc-700 text-center py-4">
                        ...
                        return (
                          <div key={step.key} className="flex items-center gap-3 relative">
                            <div className={`w-3.5 h-3.5 rounded-full border-2 flex items-center justify-center flex-shrink-0 -ml-[1px] transition-all duration-500 ${
                              done    ? 'bg-[#3ECF8E] border-[#3ECF8E] shadow-[0_0_8px_rgba(62,207,142,0.4)]' :
                              current ? 'bg-[#3ECF8E] border-[#3ECF8E] shadow-[0_0_10px_rgba(62,207,142,0.5)] ring-4 ring-[#3ECF8E]/15' :
                            ...
                            {current && (
                              <motion.span 
                                ...
                                className="ml-auto text-[9px] font-medium tracking-wider text-[#3ECF8E] bg-[#3ECF8E]/10 border border-[#3ECF8E]/20 px-2 py-0.5 rounded-full"
                              >
                                Active
                              </motion.span>
                            )}
            ...
            <div className="bg-[#0a0a0a] border border-white/[0.06] rounded-2xl overflow-hidden">
              <div className="px-5 py-4 flex items-center justify-between border-b border-white/[0.04]">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-[11px] font-medium uppercase tracking-[0.15em] text-zinc-500">Notifications</h3>
                </div>
                {unread.length > 0 && (
                  <span className="text-[10px] font-medium text-[#3ECF8E] bg-[#3ECF8E]/10 border border-[#3ECF8E]/20 px-2 py-0.5 rounded-full">
              ...
              <div className="divide-y divide-white/[0.03]">
                {loadingNotes ? (
                  ...
                  <div className="p-8 text-center">
                    ...
                    <p className="text-[12px] text-zinc-600">No notifications</p>
                  </div>
                ) : (
              ...
              <div className="px-5 py-3 border-t border-white/[0.04]">
                <Link href="/client-portal/notifications" className="text-[12px] text-[#3ECF8E] hover:text-[#3ECF8E]/80 font-medium tracking-tight flex items-center gap-1 transition-colors">
            ...
            <div className="bg-[#0a0a0a] border border-white/[0.06] rounded-2xl p-5 relative overflow-hidden group">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="text-[11px] font-medium uppercase tracking-[0.15em] text-zinc-500">Security & Trust</h3>
                </div>
