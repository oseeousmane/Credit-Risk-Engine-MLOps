...
export default function ContactPage() {
  ...
  return (
    <main className="antialiased min-h-screen bg-surface-0 relative overflow-hidden">
      ...
      <div className="absolute top-[-10%] left-0 w-[800px] h-[600px] bg-brand-400/[0.08] blur-[150px] rounded-[100%] mix-blend-screen opacity-50 pointer-events-none z-0" />
      ...
      <div className="max-w-6xl mx-auto px-6 grid lg:grid-cols-[1fr,450px] gap-16 pt-36 pb-32 relative z-10">
        ...
        <div>
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/[0.04] border border-white/[0.08] mb-8 shadow-sm">
              <span className="text-[11px] font-bold uppercase tracking-[0.25em] text-brand-400">{t.badge}</span>
            </div>
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.1 }}>
            <div className="bg-[#080808] border border-white/[0.03] hover:border-white/[0.05] transition-colors rounded-3xl p-8 sm:p-10 shadow-2xl relative overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-br from-brand-400/[0.02] to-transparent opacity-100 pointer-events-none" />
              <form className="space-y-6 relative z-10" onSubmit={(e) => e.preventDefault()}>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div className="space-y-2 group">
                    <label className="text-[13px] font-medium text-zinc-400 group-focus-within:text-brand-400 transition-colors">{t.firstName}</label>
                    <input type="text" className="w-full bg-[#030303] border border-white/[0.04] rounded-xl px-4 py-3.5 text-white focus:outline-none focus:border-brand-400/50 focus:bg-[#0a0a0a] focus:shadow-[0_0_15px_rgba(59,123,255,0.1)] transition-all" />
                  </div>
                  <div className="space-y-2 group">
                    <label className="text-[13px] font-medium text-zinc-400 group-focus-within:text-brand-400 transition-colors">{t.lastName}</label>
                    <input type="text" className="w-full bg-[#030303] border border-white/[0.04] rounded-xl px-4 py-3.5 text-white focus:outline-none focus:border-brand-400/50 focus:bg-[#0a0a0a] focus:shadow-[0_0_15px_rgba(59,123,255,0.1)] transition-all" />
                  </div>
                </div>

                <div className="space-y-2 group">
                  <label className="text-[13px] font-medium text-zinc-400 group-focus-within:text-brand-400 transition-colors">{t.email}</label>
                  <input type="email" placeholder={t.emailPlaceholder} className="w-full bg-[#030303] border border-white/[0.04] rounded-xl px-4 py-3.5 text-white placeholder-zinc-600 focus:outline-none focus:border-brand-400/50 focus:bg-[#0a0a0a] focus:shadow-[0_0_15px_rgba(59,123,255,0.1)] transition-all" />
                </div>

                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div className="space-y-2 group">
                    <label className="text-[13px] font-medium text-zinc-400 group-focus-within:text-brand-400 transition-colors">{t.company}</label>
                    <input type="text" className="w-full bg-[#030303] border border-white/[0.04] rounded-xl px-4 py-3.5 text-white focus:outline-none focus:border-brand-400/50 focus:bg-[#0a0a0a] focus:shadow-[0_0_15px_rgba(59,123,255,0.1)] transition-all" />
                  </div>
                  <div className="space-y-2 group">
                    <label className="text-[13px] font-medium text-zinc-400 group-focus-within:text-brand-400 transition-colors">{t.role}</label>
                    <select className="w-full bg-[#030303] border border-white/[0.04] rounded-xl px-4 py-3.5 text-zinc-300 focus:text-white focus:outline-none focus:border-brand-400/50 focus:bg-[#0a0a0a] focus:shadow-[0_0_15px_rgba(59,123,255,0.1)] transition-all appearance-none cursor-pointer">
                      {t.roleOptions.map((opt, i) => (
                        <option key={i} value={i === 0 ? '' : opt.toLowerCase()} className="bg-surface-0">{opt}</option>
                      ))}
                    </select>
                  </div>
                </div>
                ...
                <div className="space-y-2 group">
                  <label className="text-[13px] font-medium text-zinc-400 group-focus-within:text-brand-400 transition-colors">{t.interest}</label>
                  <select className="w-full bg-[#030303] border border-white/[0.04] rounded-xl px-4 py-3.5 text-zinc-300 focus:text-white focus:outline-none focus:border-brand-400/50 focus:bg-[#0a0a0a] focus:shadow-[0_0_15px_rgba(59,123,255,0.1)] transition-all appearance-none cursor-pointer">
                ...
                <div className="space-y-2 group">
                  <label className="text-[13px] font-medium text-zinc-400 group-focus-within:text-brand-400 transition-colors">{t.message}</label>
                  <textarea rows={4} className="w-full bg-[#030303] border border-white/[0.04] rounded-xl px-4 py-3 text-white focus:outline-none focus:border-brand-400/50 focus:bg-[#0a0a0a] focus:shadow-[0_0_15px_rgba(59,123,255,0.1)] transition-all resize-none"></textarea>
                </div>

                <button className="w-full flex items-center justify-center gap-2 px-4 py-3.5 bg-brand-400 hover:bg-brand-400/90 rounded-xl text-surface-0 font-semibold text-[14px] transition-all duration-300 mt-6 group shadow-[0_0_24px_rgba(59,123,255,0.2)]">
                  {t.submit}
        ...
        <div className="space-y-8 pt-8 lg:pt-0">
                  ...
                  {t.steps.map((step, i) => (
                    <li key={i} className="flex gap-4">
                      <div className="w-8 h-8 rounded-full bg-white/[0.03] border border-white/[0.05] flex items-center justify-center flex-shrink-0 mt-0.5 shadow-sm">
                        <span className="text-[13px] font-bold text-brand-400">{i + 1}</span>
                      </div>
                      <div>
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.3 }}>
            <div className="bg-[#080808] border border-white/[0.03] rounded-3xl p-8 shadow-xl relative overflow-hidden group">
              <div className="absolute inset-0 bg-gradient-to-br from-brand-400/[0.02] to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              <div className="relative z-10">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/[0.04] border border-white/[0.08] mb-6 shadow-sm">
