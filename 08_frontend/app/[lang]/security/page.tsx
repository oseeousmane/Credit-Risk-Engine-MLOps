    ...
    <main className="antialiased min-h-screen bg-[#050505]">
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-24">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/[0.04] border border-white/[0.08] mb-6 shadow-sm">
              <span className="text-[11px] font-bold uppercase tracking-[0.25em] text-[#3ECF8E]">Architecture</span>
            </div>
                  ...
                  return (
                    <div key={i} className="group">
                      <div className="flex items-center gap-3 mb-3">
                        <div className="w-10 h-10 rounded-lg flex items-center justify-center bg-white/[0.03] border border-white/[0.08] group-hover:bg-[#3ECF8E]/10 group-hover:border-[#3ECF8E]/20 transition-colors duration-500">
                          <Icon className="w-4 h-4 text-zinc-400 group-hover:text-[#3ECF8E] transition-colors duration-500" />
                        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
             <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="flex justify-center order-2 lg:order-1">
                <div className="relative w-64 h-64">
                  <div className="absolute inset-0 border border-[#3ECF8E]/20 rounded-full animate-[spin_10s_linear_infinite]" />
                  <div className="absolute inset-4 border border-[#3ECF8E]/10 rounded-full animate-[spin_15s_linear_infinite_reverse]" />
                  <div className="absolute inset-8 border border-white/5 rounded-full" />
                  <div className="absolute inset-0 flex items-center justify-center">
                    <Shield className="w-16 h-16 text-[#3ECF8E] drop-shadow-[0_0_15px_rgba(62,207,142,0.3)]" />
                  </div>
                </div>
            </motion.div>
      ...
      <section className="py-24">
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="max-w-6xl mx-auto px-6">
          <div className="relative rounded-3xl border border-white/[0.03] bg-[#080808] overflow-hidden shadow-2xl">
            <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-[#3ECF8E]/[0.02] rounded-full blur-[100px] pointer-events-none" />

            <div className="relative z-10 p-12 md:p-16 text-center max-w-3xl mx-auto">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#3ECF8E]/10 border border-[#3ECF8E]/20 mb-6 shadow-sm">
                <span className="w-1.5 h-1.5 rounded-full bg-[#3ECF8E] animate-pulse" />
                <span className="text-[11px] font-bold uppercase tracking-[0.25em] text-[#3ECF8E]">{t.deployBadge}</span>
              </div>
              ...
              <Link href={`/${locale}/contact`} className="inline-flex items-center gap-2 text-[14px] font-semibold text-[#3ECF8E] hover:text-[#3ECF8E]/80 transition-colors">
      ...
      <section className="max-w-4xl mx-auto px-6 pb-24">
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }}
          className="relative bg-[#050505] border border-white/[0.03] rounded-3xl p-16 text-center overflow-hidden shadow-2xl">
