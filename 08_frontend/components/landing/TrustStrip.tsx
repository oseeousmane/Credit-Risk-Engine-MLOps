...
export function TrustStrip() {
  ...
  return (
    <section className="relative py-10 border-b border-white/[0.03] bg-[#050505]">
          ...
          {items.map((item) => (
            <div key={item.label} className="flex items-center gap-3 group cursor-default">
              <div className="flex items-center justify-center transition-transform duration-500 group-hover:scale-110">
                <item.icon className="w-5 h-5 text-zinc-600 group-hover:text-[#3ECF8E] transition-all duration-500 drop-shadow-[0_0_0_rgba(62,207,142,0)] group-hover:drop-shadow-[0_0_12px_rgba(62,207,142,0.4)]" strokeWidth={1.5} />
              </div>
