      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/[0.04] border border-white/[0.08] mb-6 shadow-sm">
            <span className="text-[11px] font-bold uppercase tracking-[0.25em] text-[#3ECF8E]">Leadership</span>
          </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {leaders.map((leader, i) => (
            <motion.div
              ...
              className="p-8 bg-[#050505] border border-white/[0.03] rounded-2xl hover:border-white/[0.08] hover:bg-[#080808] transition-all duration-500 group relative shadow-xl overflow-hidden"
            >
              ...
              {/* Avatar placeholder */}
              <div className="relative z-10 w-16 h-16 rounded-xl bg-white/[0.02] border border-white/[0.04] flex items-center justify-center mb-6 group-hover:border-[#3ECF8E]/30 group-hover:bg-[#3ECF8E]/10 transition-colors duration-500">
                <span className="text-[16px] font-medium text-zinc-500 group-hover:text-[#3ECF8E] transition-colors duration-500">{leader.initials}</span>
              </div>
              
              <h3 className="relative z-10 text-xl font-medium text-white mb-1">{leader.name}</h3>
              <p className="text-[12px] font-bold uppercase tracking-[0.1em] text-[#3ECF8E] mb-4">{leader.role}</p>
              <p className="text-[13px] font-medium text-zinc-500 leading-relaxed mb-6">
                {leader.background}
              </p>
              
              <div className="relative z-10 mt-auto">
                <a href="#" className="inline-flex items-center gap-1 text-[13px] font-semibold text-[#3ECF8E] hover:text-[#3ECF8E]/80 transition-colors">
