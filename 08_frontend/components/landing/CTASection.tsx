  ...
  return (
    <section className="py-28 relative">
      <div className="max-w-5xl mx-auto px-6">
        <div className="relative text-center py-20 px-8 rounded-3xl overflow-hidden border border-white/[0.03] bg-[#050505]">
          <div className="absolute inset-0 bg-gradient-to-br from-[#3ECF8E]/[0.02] to-transparent pointer-events-none" />
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-[#3ECF8E]/[0.05] rounded-full blur-[100px] pointer-events-none" />
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <Link href={`/${locale}/contact`} className="inline-flex items-center justify-center px-4 py-2 bg-[#3ECF8E] text-[#0a0a0a] text-[13px] font-semibold rounded-md hover:bg-[#3ECF8E]/90 transition-colors">
                {t.cta1}
              </Link>
