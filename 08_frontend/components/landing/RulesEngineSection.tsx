      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-20">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/[0.04] border border-white/[0.08] mb-6 shadow-sm">
            <span className="text-[11px] font-bold uppercase tracking-[0.25em] text-[#3ECF8E]">The Brain</span>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <motion.div 
            ...
            className="p-8 rounded-2xl bg-[#050505] border border-white/[0.03] hover:border-white/[0.08] transition-colors group relative overflow-hidden"
          >
            <div className="absolute top-0 right-0 p-8 opacity-5">
              <Bot className="w-32 h-32" />
            </div>
            <div className="w-10 h-10 rounded-lg flex items-center justify-center mb-6 bg-white/[0.03] border border-white/[0.08] group-hover:bg-[#3ECF8E]/10 group-hover:border-[#3ECF8E]/20 transition-colors duration-500">
              <Bot className="w-4 h-4 text-zinc-400 group-hover:text-[#3ECF8E] transition-colors duration-500" />
            </div>
            ...
            <div className="mt-auto inline-flex items-center text-[12px] font-mono text-[#3ECF8E]">
              PD_1Y: 1.42%
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="w-10 h-10 rounded-lg flex items-center justify-center mb-6 bg-white/[0.03] border border-white/[0.08] group-hover:bg-[#3ECF8E]/10 group-hover:border-[#3ECF8E]/20 transition-colors duration-500">
              <Filter className="w-4 h-4 text-zinc-400 group-hover:text-[#3ECF8E] transition-colors duration-500" />
            </div>
            ...
            <p className="text-[14px] font-medium text-zinc-500 leading-relaxed mb-4">
              Deterministic rules act as guardrails. E.g., "Auto-reject if Days Past Due &gt; 30" or "Escalate if exposure &gt; $10M".
            </p>
          ...
          >
            ...
            <div className="w-10 h-10 rounded-lg flex items-center justify-center mb-6 bg-white/[0.03] border border-white/[0.08] group-hover:bg-[#3ECF8E]/10 group-hover:border-[#3ECF8E]/20 transition-colors duration-500">
              <LineChart className="w-4 h-4 text-zinc-400 group-hover:text-[#3ECF8E] transition-colors duration-500" />
            </div>
            ...
            <div className="mt-auto inline-flex flex-col w-full gap-2">
              <div className="w-full h-1.5 bg-white/[0.05] rounded-full overflow-hidden flex">
                <div className="h-full bg-[#3ECF8E]/30 w-[40%] transition-colors group-hover:bg-[#3ECF8E]/50" />
                <div className="h-full bg-[#3ECF8E]/80 w-[60%] transition-colors group-hover:bg-[#3ECF8E]" />
              </div>
            </div>
          </motion.div>
        </div>
