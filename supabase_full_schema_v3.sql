-- CreateEnum
DO $$ BEGIN
    CREATE TYPE "Role" AS ENUM ('CLIENT', 'ANALYST', 'MANAGER', 'CRO', 'ADMIN');
EXCEPTION WHEN duplicate_object THEN null;
END $$;

-- CreateEnum
DO $$ BEGIN
    CREATE TYPE "RiskRating" AS ENUM ('AAA', 'AA_PLUS', 'AA', 'AA_MINUS', 'A_PLUS', 'A', 'A_MINUS', 'BBB_PLUS', 'BBB', 'BBB_MINUS', 'BB_PLUS', 'BB', 'B', 'CCC', 'D');
EXCEPTION WHEN duplicate_object THEN null;
END $$;
...
-- CreateEnum
DO $$ BEGIN
    CREATE TYPE "DecisionStatus" AS ENUM ('APPROVE', 'APPROVE_WITH_CONDITIONS', 'SEND_TO_REVIEW', 'REJECT', 'PENDING');
EXCEPTION WHEN duplicate_object THEN null;
END $$;

-- CreateEnum
DO $$ BEGIN
    CREATE TYPE "PipelineStage" AS ENUM ('SUBMITTED', 'DOCUMENTS_PENDING', 'DOCUMENTS_VALIDATED', 'SCORED', 'ANALYST_REVIEW', 'MANAGER_REVIEW', 'COMMITTEE_REVIEW', 'APPROVED', 'APPROVED_WITH_CONDITIONS', 'REJECTED');
EXCEPTION WHEN duplicate_object THEN null;
END $$;

-- CreateEnum
DO $$ BEGIN
    CREATE TYPE "DocumentStatus" AS ENUM ('REQUIRED', 'UPLOADED', 'PENDING_VALIDATION', 'VALIDATED', 'REJECTED');
EXCEPTION WHEN duplicate_object THEN null;
END $$;
...
-- CreateEnum
DO $$ BEGIN
    CREATE TYPE "ModelStatus" AS ENUM ('HEALTHY', 'WARNING', 'DEGRADED');
EXCEPTION WHEN duplicate_object THEN null;
END $$;

-- CreateEnum
DO $$ BEGIN
    CREATE TYPE "LifecycleStatus" AS ENUM ('CANDIDATE', 'CHALLENGER', 'CHAMPION', 'ARCHIVED');
EXCEPTION WHEN duplicate_object THEN null;
END $$;

-- CreateEnum
DO $$ BEGIN
    CREATE TYPE "DeploymentStatus" AS ENUM ('DISABLED', 'SHADOW', 'PRODUCTION');
EXCEPTION WHEN duplicate_object THEN null;
END $$;

-- CreateEnum
DO $$ BEGIN
    CREATE TYPE "IFRS9Stage" AS ENUM ('STAGE_1', 'STAGE_2', 'STAGE_3');
EXCEPTION WHEN duplicate_object THEN null;
END $$;

-- CreateEnum
DO $$ BEGIN
    CREATE TYPE "ComplianceStatus" AS ENUM ('COMPLIANT', 'REVIEW', 'FAILED', 'NOT_APPLICABLE');
EXCEPTION WHEN duplicate_object THEN null;
END $$;

-- CreateEnum
DO $$ BEGIN
    CREATE TYPE "ArtifactCategory" AS ENUM ('DEMO_BASELINE', 'PROD_CHAMPION', 'TECHNICAL_ARTIFACT');
EXCEPTION WHEN duplicate_object THEN null;
END $$;
...
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "Counterparty_lei_key" ON "Counterparty"("lei");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "Application_reqId_key" ON "Application"("reqId");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "Decision_applicationId_key" ON "Decision"("applicationId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "AuditEvent_entityType_entityId_idx" ON "AuditEvent"("entityType", "entityId");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "RetailBorrower_externalId_key" ON "RetailBorrower"("externalId");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "RetailBorrower_phone_key" ON "RetailBorrower"("phone");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "RetailBorrower_segment_status_idx" ON "RetailBorrower"("segment", "status");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "RetailBorrower_phone_idx" ON "RetailBorrower"("phone");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "InformalBusinessProfile_borrowerId_key" ON "InformalBusinessProfile"("borrowerId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "ConsentGrant_borrowerId_sourceType_purpose_status_idx" ON "ConsentGrant"("borrowerId", "sourceType", "purpose", "status");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "MicroLoanPolicy_productType_segment_status_idx" ON "MicroLoanPolicy"("productType", "segment", "status");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "MicroLoanPolicy_name_version_key" ON "MicroLoanPolicy"("name", "version");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "ProductPolicySnapshot_applicationId_key" ON "ProductPolicySnapshot"("applicationId");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "MicroLoanApplication_reqId_key" ON "MicroLoanApplication"("reqId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "MicroLoanApplication_borrowerId_status_idx" ON "MicroLoanApplication"("borrowerId", "status");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "MicroLoanApplication_segment_productType_status_idx" ON "MicroLoanApplication"("segment", "productType", "status");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "FieldVisit_applicationId_status_idx" ON "FieldVisit"("applicationId", "status");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "FieldVisit_borrowerId_status_idx" ON "FieldVisit"("borrowerId", "status");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "Guarantor_applicationId_idx" ON "Guarantor"("applicationId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "Guarantor_borrowerId_idx" ON "Guarantor"("borrowerId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "GroupMembership_borrowerId_active_idx" ON "GroupMembership"("borrowerId", "active");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "ThinFileScorecard_applicationId_createdAt_idx" ON "ThinFileScorecard"("applicationId", "createdAt");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "ThinFileScorecard_borrowerId_createdAt_idx" ON "ThinFileScorecard"("borrowerId", "createdAt");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "MicroLoanDecision_applicationId_createdAt_idx" ON "MicroLoanDecision"("applicationId", "createdAt");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "MicroLoanDecision_borrowerId_status_idx" ON "MicroLoanDecision"("borrowerId", "status");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "LoanOffer_applicationId_status_idx" ON "LoanOffer"("applicationId", "status");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "LoanOffer_borrowerId_status_idx" ON "LoanOffer"("borrowerId", "status");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "Disbursement_loanAccountId_key" ON "Disbursement"("loanAccountId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "Disbursement_loanOfferId_status_idx" ON "Disbursement"("loanOfferId", "status");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "Disbursement_borrowerId_status_idx" ON "Disbursement"("borrowerId", "status");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "LoanAccount_accountNumber_key" ON "LoanAccount"("accountNumber");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "LoanAccount_loanOfferId_key" ON "LoanAccount"("loanOfferId");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "LoanAccount_applicationId_key" ON "LoanAccount"("applicationId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "LoanAccount_borrowerId_status_idx" ON "LoanAccount"("borrowerId", "status");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "RepaymentSchedule_loanAccountId_dueDate_status_idx" ON "RepaymentSchedule"("loanAccountId", "dueDate", "status");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "RepaymentSchedule_loanAccountId_installmentNumber_key" ON "RepaymentSchedule"("loanAccountId", "installmentNumber");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "RepaymentEvent_loanAccountId_receivedAt_idx" ON "RepaymentEvent"("loanAccountId", "receivedAt");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "RepaymentEvent_borrowerId_receivedAt_idx" ON "RepaymentEvent"("borrowerId", "receivedAt");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "DelinquencyEvent_loanAccountId_status_idx" ON "DelinquencyEvent"("loanAccountId", "status");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "DelinquencyEvent_borrowerId_status_idx" ON "DelinquencyEvent"("borrowerId", "status");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "CollectionAction_loanAccountId_status_idx" ON "CollectionAction"("loanAccountId", "status");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "CollectionAction_borrowerId_status_idx" ON "CollectionAction"("borrowerId", "status");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "CollectionAction_delinquencyEventId_idx" ON "CollectionAction"("delinquencyEventId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "MobileMoneySnapshot_borrowerId_capturedAt_idx" ON "MobileMoneySnapshot"("borrowerId", "capturedAt");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "MobileMoneySnapshot_consentGrantId_idx" ON "MobileMoneySnapshot"("consentGrantId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "AlternativeDataFeatureSnapshot_borrowerId_sourceType_create_idx" ON "AlternativeDataFeatureSnapshot"("borrowerId", "sourceType", "createdAt");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "AlternativeDataFeatureSnapshot_applicationId_idx" ON "AlternativeDataFeatureSnapshot"("applicationId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "FairnessMetric_segment_metricName_windowEnd_idx" ON "FairnessMetric"("segment", "metricName", "windowEnd");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "TransactionRecord_internalRef_key" ON "TransactionRecord"("internalRef");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "TransactionRecord_disbursementId_key" ON "TransactionRecord"("disbursementId");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "TransactionRecord_repaymentEventId_key" ON "TransactionRecord"("repaymentEventId");
